...
function makeAvailableArr(disabledList: boolean[]): number[] {
  const trueOrNumber = (isDisabled: boolean, index: number) => isDisabled || index
...
export function getTimeLists(disabledHours?: GetDisabledHours, disabledMinutes?: GetDisabledMinutes, disabledSeconds?: GetDisabledSeconds) {
...
export function buildAvailableTimeSlotGetter(disabledHours: GetDisabledHours, disabledMinutes: GetDisabledMinutes, disabledSeconds: GetDisabledSeconds) {
