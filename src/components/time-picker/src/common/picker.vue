...
import { onClickOutside } from '@datadayrepos/usevuecore'
...
function emitChange(val: TimePickerDefaultProps['modelValue'] | null, isClear?: boolean) {
...
function onCalendarChange(e: [Date, null | Date]) {
  emit('calendar-change', e)
}

function onPanelChange(value: [Dayjs, Dayjs], mode: 'month' | 'year', view: unknown) {
