...
function findNextUnDisabled(type: TimeUnit, now: number, step: number, total: number) {
...
function handleClick(type: TimeUnit, { value, disabled }: { value: number; disabled: boolean }) {
  if (!disabled) {
