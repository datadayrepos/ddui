...
import type { Alignment as ScrollStrategy } from '/@/components/virtual-list'
import type { TableV2Props } from '../table'
import type { TableGridInstance } from '../table-grid'

export interface ScrollPos { scrollLeft: number; scrollTop: number }
...
export function useScrollbar(props: TableV2Props, {
  mainTableRef,
  leftTableRef,
  rightTableRef,
  onMaybeEndReached,
