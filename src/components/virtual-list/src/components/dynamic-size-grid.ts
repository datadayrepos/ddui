...
import { isNumber, isUndefined, throwError } from '/@/utils'
...
function getItemFromCache(props: Props, index: number, gridCache: GridCache, type: CacheItemType) {
...
function bs(props: Props, gridCache: GridCache, low: number, high: number, offset: number, type: CacheItemType) {
  while (low <= high) {
...
function es(props: Props, gridCache: GridCache, idx: number, offset: number, type: CacheItemType) {
...
function findItem(props: Props, gridCache: GridCache, offset: number, type: CacheItemType) {
...
function getEstimatedTotalHeight({ totalRow }: Props, { estimatedRowHeight, lastVisitedRowIndex, row }: GridCache) {
...
function getEstimatedTotalWidth({ totalColumn }: Props, { column, estimatedColumnWidth, lastVisitedColumnIndex }: GridCache) {
...
function getOffset(props: Props, index: number, alignment: Alignment, scrollOffset: number, cache: GridCache, type: CacheItemType, scrollBarWidth: number) {
