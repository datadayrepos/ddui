...
async function addStyle(options: LoadingOptionsResolved, parent: HTMLElement, instance: LoadingInstance) {
...
function addClassList(options: LoadingOptions, parent: HTMLElement, instance: LoadingInstance) {
  // Compatible with the instance data format of vue@3.2.12 and earlier versions #12351
  const ns
