...
import type { UseResizeObserverReturn } from '@datadayrepos/usevuecore'
...
function checkIndexPath(indexPath: unknown): indexPath is string[] {
  return Array.isArray(indexPath) && indexPath.every(path => isString(path))
}
