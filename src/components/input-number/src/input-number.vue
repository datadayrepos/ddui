...
function verifyValue(value: number | string | null | undefined, update?: boolean): number | null | undefined {
...
function setCurrentValue(value: number | string | null | undefined, emitChange = true) {
