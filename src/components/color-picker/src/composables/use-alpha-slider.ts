...
import { addUnit, getClientXY } from '/@/utils'
import { useNamespace } from '/@/hooks'
import { draggable } from '../utils/draggable'

import type { AlphaSliderProps } from '../props/alpha-slider'

export function useAlphaSlider(props: AlphaSliderProps) {
...
export function useAlphaSliderDOM(props: AlphaSliderProps, {
  bar,
  thumb,
  handleDrag,
  ...
  return { barKls, barStyle, rootKls, thumbKls, thumbStyle, update }
}
