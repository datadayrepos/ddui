...
export function getVisibleElement(elements: HTMLElement[], container: HTMLElement) {
...
export function tryFocus(element?: HTMLElement | { focus: () => void } | null, shouldSelect?: boolean) {
...
export function focusFirstDescendant(elements: HTMLElement[], shouldSelect = false) {
  const prevFocusedElement = document.activeElement
  for (const element of elements) {
