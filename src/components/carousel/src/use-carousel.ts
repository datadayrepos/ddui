...
import { debugWarn, flattedChildren, isString } from '/@/utils'
...
export function useCarousel(props: CarouselProps, emit: SetupContext<CarouselEmits>['emit'], componentName: string) {
  const {
    children: items,
    addChild: addItem,
  ...
  }, THROTTLE_TIME, {}) // Providing an empty options object
