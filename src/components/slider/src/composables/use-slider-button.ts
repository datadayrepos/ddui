...
import { debounce } from '@datadayrepos/lodashts'
...
function useTooltip(props: SliderButtonProps, formatTooltip: Ref<SliderProps['formatTooltip']>, showTooltip: Ref<SliderProps['showTooltip']>) {
...
// eslint-disable-next-line datadayrepos/top-level-function
