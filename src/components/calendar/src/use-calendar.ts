...
import { useDeprecated, useLocale } from '/@/hooks'
...
function adjacentMonth(start: Dayjs, end: Dayjs): [Dayjs, Dayjs][] {
...
function threeConsecutiveMonth(start: Dayjs, end: Dayjs): [Dayjs, Dayjs][] {
  const firstMonthLastDay = start.endOf('month')
...
export function useCalendar(props: CalendarProps, emit: SetupContext<CalendarEmits>['emit'], componentName: string) {
