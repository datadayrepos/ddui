<template>
  ...
  >
    ...
    <ElIcon v-else-if="isLeaf && node.checked" :class="ns.e('prefix')">
      <Check />
    </ElIcon>
    ...
    <template v-if="!isLeaf">
      <ElIcon v-if="node.loading" :class="[ns.is('loading'), ns.e('postfix')]">
        <Loading />
      </ElIcon>
      <ElIcon v-else class="arrow-right" :class="[ns.e('postfix')]">
        <ArrowRight />
      </ElIcon>
    </template>
  </li>
