...
function datesInYear(year: number, lang: string) {
...
function getCellKls(year: number) {
...
function isSelectedCell(year: number) {
  return (
...
function handleYearTableClick(event: MouseEvent | KeyboardEvent) {
